...
execute anchored eyes positioned ^ ^ ^9 align xyz as @e[type=item_display,distance=..0.0001,limit=1,tag=area_selector.selecting_area.root] run function area_selector:core/area/selecting/tag with storage area_selector:_ var
