...
$execute as $(conved_player_uuid) if entity @s[tag=area_selector.selecting_area.pause] run data modify storage area_selector:_ data.$(conved_player_uuid) set from storage pte_link:_ data.$(conved_player_uuid).area_selector
