...
execute unless score $prev_phase_list_length helperbar >= $prev_total_phase helperbar run function helperbar:core/bossbar/phase/modify/prev/ with storage helperbar:_ macro